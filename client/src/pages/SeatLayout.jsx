...
const handleSeatClick = (seatId) => {
  ...
  <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-30 py-30 md:pt-50'>
    ...
    <button onClick = {() => navigate('/my-bookings')} className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-[#FF3B2E] hover:bg-[#e03528] transition text-white rounded-md font-medium cursor-pointer active:scale-95'>
      Proceed to Checkout

  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className="relative pb-4">
        ...
        <div
          ref={scrollRef}
          className="group flex gap-4 mt-4 overflow-x-auto no-scrollbar scroll-smooth"
        >
        ...
        <button
          onClick={scrollLeft}
          className="absolute top-1/2 left-2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white rounded-full p-2 shadow-lg cursor-pointer"
        >
          <ChevronLeft size={20} />
        </button>
        ...
        <button
          onClick={scrollRight}
          className="absolute top-1/2 right-2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white rounded-full p-2 shadow-lg cursor-pointer"
        >
